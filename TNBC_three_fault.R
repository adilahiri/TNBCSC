TNBC_three_fault <- function(fault1, fault2, fault3, x1, x2, x3, x4, x5,x6,x7,x8,x9,x10,x11) {
  ...
  if (fault1 == 34 || fault2==34 || fault3==34) {
    IKK=1;     
  }
  else {
  ...
  if (fault1 == 35 || fault2==35 || fault3==35) {
    IKBa=1;     
  }
  else{
    IKBa= IKK;
  ...
  if (fault1 == 36 || fault2==36 || fault3==36) {
    P27=1;  
  }
  else {
    P27= !AKT_INV; 
  ...
  if (fault1 == 37 || fault2==37 || fault3==37) {
    IL6R=1;    
  }
  else {
    IL6R= IL6;
  ...
  if (fault1 == 38 || fault2==38 || fault3==38) {
    IL8R=1;    
  }
  else{
    IL8R= IL8;
  ...
  if (fault1 == 39 || fault2==39 || fault3==39) {
    LEPR=1;    
  }
  else {
    LEPR= LEP | HNL1;
  ...
  if (fault1 == 40 || fault2==40 || fault3==40) {
    JAK2=1;    
  }
  else{
  ...
  if (fault1 == 41 || fault2==41 || fault3==41) {
    STAT3=1;    
  }
  else {
    STAT3=JAK2;       
  ...
  if (fault1 == 42 || fault2==42 || fault3==42) {
    NFKB=1;    
  }
  else {
